...
class NumberInput
  ...
  def words()
    ...
    if (number_array.length - 1) % 3 == 0 || number_array.length - 1 == 0
      ...
      if number_array[0] == '1' && number_array[1] == '0'
        number_array.shift
        words_array.push('ten')
      elsif number_array[0] == '1'
        number_array.shift
...
if length_number === 4
...
elsif length_number === 5
  words_array.insert(2," thousand ")
elsif length_number === 6
  words_array.insert(3," thousand ")
  ...
  words_array.insert(3," billion ")
  words_array.insert(7," million ")
  words_array.insert(11," thousand ")
elsif length_number === 13
  words_array.insert(1, ' trillion ')
  words_array.insert(4," billion ")
  words_array.insert(7," million ")
  words_array.insert(11," thousand ")
end
